...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2024 at 06:16 PM
...
ALTER TABLE `bookmark`
  ...
  ADD CONSTRAINT `bookmark_Offices_FK` FOREIGN KEY (`room_id`) REFERENCES `offices_room` (`room_id`);

--
-- Constraints for table `building_offices`
--
ALTER TABLE `building_offices`
  ADD CONSTRAINT `building_offices_Buildings_FK` FOREIGN KEY (`building_id`) REFERENCES `buildings` (`building_id`),
...
--
ALTER TABLE `offices_room`
  ADD CONSTRAINT `offices_room_Offices_FK` FOREIGN KEY (`office_id`) REFERENCES `offices` (`office_id`),
