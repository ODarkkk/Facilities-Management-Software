...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2024 at 04:47 PM
...
--
-- RELATIONSHIPS FOR TABLE `bookmark`:
--   `room_id`
...
--
-- RELATIONSHIPS FOR TABLE `building_offices`:
--   `building_id`
...
--
-- RELATIONSHIPS FOR TABLE `offices`:
--
...
--
-- RELATIONSHIPS FOR TABLE `offices_room`:
--   `office_id`
--       `offices` -> `office_id`
--   `room_id`
--       `room` -> `room_id`
...
--
-- RELATIONSHIPS FOR TABLE `people`:
--   `role_department_id`
--       `roles_department` -> `roles_department_id`
--
...
--
-- RELATIONSHIPS FOR TABLE `recover`:
--
...
--
-- RELATIONSHIPS FOR TABLE `roles_department`:
--   `department_id`
...
--
ALTER TABLE `bookmark`
  ADD CONSTRAINT `Bookmark_Offices_room_FK_1` FOREIGN KEY (`room_id`) REFERENCES `offices_room` (`room_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `Bookmark_People_FK_2` FOREIGN KEY (`people_id`) REFERENCES `people` (`people_id`) ON DELETE CASCADE;

--
-- Constraints for table `building_offices`
--
ALTER TABLE `building_offices`
  ADD CONSTRAINT `Building_offices_Building_FK` FOREIGN KEY (`building_id`) REFERENCES `buildings` (`building_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `Building_offices_Offices_FK` FOREIGN KEY (`office_id`) REFERENCES `offices` (`office_id`) ON DELETE CASCADE;

--
-- Constraints for table `offices_room`
--
ALTER TABLE `offices_room`
  ADD CONSTRAINT `Offices_room_Oficces_FK` FOREIGN KEY (`office_id`) REFERENCES `offices` (`office_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `Offices_room_Room_FK` FOREIGN KEY (`room_id`) REFERENCES `room` (`room_id`) ON DELETE CASCADE;

--
-- Constraints for table `people`
--
ALTER TABLE `people`
  ADD CONSTRAINT `people_Role_department_FK_1` FOREIGN KEY (`role_department_id`) REFERENCES `roles_department` (`roles_department_id`) ON DELETE CASCADE;

--
-- Constraints for table `roles_department`
--
ALTER TABLE `roles_department`
  ADD CONSTRAINT `roles_department_Department_FK_2` FOREIGN KEY (`department_id`) REFERENCES `department` (`department_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `roles_department_Roles_FK_1` FOREIGN KEY (`role_id`) REFERENCES `roles` (`role_id`) ON DELETE CASCADE;
