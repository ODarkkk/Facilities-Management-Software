...
<nav class="navbar navbar-light bg-light navbar-expand-lg navbar-light" style="transition: height 0.5s;">
        ...
        <div class="container mt-5 d-flex justify-content-center">
            ...
            <!-- <h5>Admin Credentials</h5>
                ...
                <input type="text" class="form-control custom-input" name="username" id="username"<?php if ($edit==true){"value = ". $row['user'];}?> required>
                </div>
                <div class="col-md-6">
                    <label for="name" class="form-label">Name</label>
                    <input type="text" class="form-control custom-input" name="Name" id="name" <?php if ($edit==true){"value = ".$row['name'];}?> required>
                </div>
              <?php 
              if($edit == false)
              {
              ...
              ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" class="form-control custom-input" name="Email" id="Email" <?php if ($edit == true) {  "value = " .  $row['email'];} ?> required>
                </div>
                <div class="col-md-6">
                    <label for="photo" class="form-label">Photo</label>
                    <input type="file" class="form-control custom-input" name="photo" id="photo" <?php if ($edit == true) { "value = ". $row['email'];} ?> required>
                </div>
                <?php
                 if($edit != true)
                 {
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control custom-input" name="phone" id="phone" <?php if ($edit==true){"value = ".$row['name'];}?> required>
                    </div>
                <div class="col-md-6">
