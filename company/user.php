    ...
    $(document).ready(function() {
      $.ajax({
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          console.error('Error in search:', textStatus, errorThrown);
        }
      });
  ...
  <nav class="navbar">
    <form class="form-inline">
      <div class="input-group">
        <input type="text" class="form-control" placeholder="Search" aria-label="usersearch" aria-describedby="basic-addon1" id="usersearch">
      </div>
    </form>
  </nav>
