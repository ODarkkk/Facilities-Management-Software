...
<form>
  <div class="mb-3">
    ...
    <select id="room_id" class="form-select" required>
      <?php
        ...
        $rooms = mysqli_query($conn, "SELECT * FROM offices_room");
  ...
  <div class="mb-3">
    ...
    <input type="date" id="selected_date" class="form-control" required>
  </div>

  <div class="mb-3">
    <label for="start_hour" class="form-label">Start Hour</label>
    <input type="time" id="start_hour" class="form-control" required>
  </div>

  <div class="mb-3">
    <label for="end_hour" class="form-label">End Hour</label>
    <input type="time" id="end_hour" class="form-control" required>
  </div>

  <div class="mb-3">
    <label for="active" class="form-label">Active</label>
    <div class="form-check">
      <input class="form-check-input" type="checkbox" id="active" <?php if ($bookmark['active'] == 1) echo "checked";?>>
