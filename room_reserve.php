...
$selectedDate = $_GET['selecteddate_js'];
...
?>
  ...
  <div class="d-flex justify-content-center">
    ...
    <div class="d-flex justify-content-center">
    <h2>
      <?php $sql = "SELECT room_name FROM room where room_id = ". $_GET['room_id'];
  ...
  <div class="container mt-5 my-auto d-flex justify-content-center">
  <form action="room_reserve_process.php?room_id=<?php echo $_GET['room_id'];?>" method="post">
      <div class="mb-3">
        <label for="date" class="form-label">Date:</label>
        <input type="date" class="form-control custom-input" name="date" id="date" value = <?php echo $selectedDate ?> required>
      </div>
      <div class="row">
        <div class="col-md-12">
          <label for="input1" class="form-label">Time</label>
          <div class="input-group mb-3">
            <input type="time" class="form-control" id="start_time" name = "start_time" placeholder="Enter start time" required>
            <label for="input2" class="input-group-text">at</label>
